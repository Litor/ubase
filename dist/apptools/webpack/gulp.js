...
module.exports = function (userConfig) {
  ...
  _gulp2.default.task('webpack', function () {
    return _gulp2.default.src([]).pipe(_gulpEnv2.default.set(envs)).pipe((0, _errorHandler2.default)()).pipe((0, _vinylNamed2.default)()).pipe((0, _webpackStream2.default)((0, _index2.default)(_path2.default, _webpack2.default, userConfig))).pipe(_gulp2.default.dest(dest)).pipe(_gulpConnect2.default.reload());
  });
